...
define Package/luci-theme-fate/postinst
#!/bin/sh
...
[ -f /usr/lib/lua/luci/view/themes/fate/out_header_login.htm ] && mv -f /usr/lib/lua/luci/view/themes/fate/out_header_login.htm /usr/lib/lua/luci/view/header_login.htm
